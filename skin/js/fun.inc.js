...
$('.navsearch_input input').focus(function(){$('.search label').hide();});
$('.navsearch_input input').focusout(function(){if($(this).val()=='')$('.search label').show();});	
...
$(document).ready(function(){
		$("#index-news ol.metlist").find("a:first").css({fontWeight:"bold"});
		$("#index-news ol.metlist").find("div.memo:first").show();
		$("#index-news ol.metlist").find("img:first").show();
		$("#index-news ol.metlist").find("span.time:first").hide();
		$("#index-news ol.metlist").find("li").mouseover(function(){
			$("#index-news ol.metlist").find("a").css({fontWeight:"normal"});
			$("#index-news ol.metlist").find("div.memo").hide();
			$("#index-news ol.metlist").find("img").hide();
			$("#index-news ol.metlist").find("span.time").show();
	...
	metHeight($(".aboutus11"));//等高
	metHeight($(".index-news11"));
	metHeight($(".index-case11"));
	//产品展示
	...
	$('.index-case .dl-jqrun dl:last').addClass('lastdl');
	...
	$('.sidebar #sidebar dl:last').find('dt').addClass('bno_line');
}
